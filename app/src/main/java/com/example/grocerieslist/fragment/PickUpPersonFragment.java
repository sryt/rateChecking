    ...
    public void displayData(final StockDetailsClass sdc, boolean flag){
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!nameStr.isEmpty()){
                    StockDetailsClass stockDetailsClass = new StockDetailsClass(sdc.getId(),nameStr,addStr,stateStr,pincodeStr,numStr,descStr,Constant.PERSON,statusStr,"");
