...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        HashMap<String,String> headMap = (HashMap<String, String>) getGroup(groupPosition);
        String headerTitle = headMap.get("name") ;
        String headerValue = headMap.get("value");
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        TextView lblListHeaderData = (TextView) convertView
                .findViewById(R.id.lblListHeaderData);
        lblListHeaderData.setTypeface(null, Typeface.BOLD);
        lblListHeaderData.setText(headerValue);
