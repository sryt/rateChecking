...
public class StockAdjToFileAsync extends AsyncTask<Void,Void,Void> {
    ...
    private void stopRecording() {
        try {
            ...
            addNotification(act.getResources().getString(R.string.app_name),filename.getName()+" download successful");
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    private void addNotification(String title,String msg) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(act.getApplicationContext(), "stock_notify_001");
